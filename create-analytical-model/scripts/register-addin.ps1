...
$manifestTemplatePath = Join-Path $repoRoot "src/AnalyticalImport/Manifest/AnalyticalImport.addin"
...
if (-not $AssemblyPath) {
    ...
    $AssemblyPath = Join-Path $repoRoot "src/AnalyticalImport/bin/$Configuration/$targetFramework/AnalyticalImport.dll"
}
...
$manifestOutputPath = Join-Path $addinRoot "AnalyticalImport.addin"
