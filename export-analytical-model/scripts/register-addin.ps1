...
$manifestTemplatePath = Join-Path $repoRoot "src/AnalyticalExport/Manifest/AnalyticalExport.addin"
...
if (-not $AssemblyPath) {
    ...
    $AssemblyPath = Join-Path $repoRoot "src/AnalyticalExport/bin/$Configuration/$targetFramework/AnalyticalExport.dll"
}
...
$manifestOutputPath = Join-Path $addinRoot "AnalyticalExport.addin"
