...
YEAR = 2025
APP_BUNDLE_BASENAME = "PadFoundationsDA"
ACTIVITY_BASENAME = "PadFoundationsActivity"
DEFAULT_ALIAS = "dev"
DEFAULT_OUTPUT_LOCAL_NAME = "result.rvt"
DEFAULT_PAYLOAD_LOCAL_NAME = "pad_foundations.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Deploy and run the Revit pad foundations Design Automation bundle."
    )
    ...
    parser.add_argument("--input-json", required=True, type=Path, help="Path to the pad foundations JSON payload.")
    parser.add_argument(
        "--bundle-zip",
        type=Path,
        default=script_dir / "files" / "PadFoundationsDA.bundle.zip",
...
def main() -> int:
    ...
    output_model = ActivityOutputParameter(
        ...
        verb="put",
        description="Output Revit model with pad foundations",
        bucketKey=bucket_key,
