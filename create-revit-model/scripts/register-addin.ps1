...
$manifestTemplatePath = Join-Path $repoRoot "src/RevitModelImport/Manifest/RevitModelImport.addin"
...
if (-not $AssemblyPath) {
    ...
    $AssemblyPath = Join-Path $repoRoot "src/RevitModelImport/bin/$Configuration/$targetFramework/RevitModelImport.dll"
}
...
$manifestOutputPath = Join-Path $addinRoot "RevitModelImport.addin"
