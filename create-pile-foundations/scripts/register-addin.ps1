...
$manifestTemplatePath = Join-Path $repoRoot "src/PileFoundationImport/Manifest/PileFoundationImport.addin"
...
$manifestOutputPath = Join-Path $addinRoot "PileFoundationImport.addin"
